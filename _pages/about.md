...
My research primarily focuses on three areas: [1] unsupervised representation learning, free from human annotations. [2] enhancing traditional computer vision problems through the application of diffusion/consistency models. [3] advancing the efficiency of Large Multimodal Models (LMMs). <br>
